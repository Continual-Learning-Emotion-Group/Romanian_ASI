# Romanian ASI Benchmark — Data Collection Pipeline

Unified pipeline for constructing the Romanian ASI (Affective State Identification)
benchmark — the Romanian side of the Mosaic-Emo benchmark.

This document covers data collection, benchmark construction, and the extrinsic
evaluations only. The interpretability experiments are documented in the
[top-level README](../README.md) and in [`affect_geometry/`](affect_geometry/).
