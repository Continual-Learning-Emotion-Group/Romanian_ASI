...
Usage:
    # Test directly
    modal run experiments/embedding_similarity/modal_embeddings.py

    # Called programmatically from embedding_candidates.py
"""
...
def embed_texts(
    ...
    Call this from external code (embedding_candidates.py).
